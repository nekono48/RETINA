...
pub fn ExtAudioFileRead(
    ...
    let max_bytes = first_buffer.mDataByteSize.min(frames_requested.saturating_mul(bytes_per_frame));
...
// --- Остальные AudioFileGetProperty, AudioFileReadBytes, AudioFileReadPackets и закрытие
