...
// --- Extended Audio File Properties ---
...
pub fn ExtAudioFileGetProperty(
    ...
    match in_property_id {
        kExtAudioFilePropertyFileDataFormat | kExtAudioFilePropertyClientDataFormat => {
        ...
        // Пока просто прокидываем остальные в AudioFileGetProperty
...
// --- Остальной код AudioFileOpenWithCallbacks, AudioFileGetProperty, AudioFileReadPackets и т.д. --
// оставляем без изменений, как у вас, только теперь ExtAudioFileGetProperty не падает на 'ffmt'
